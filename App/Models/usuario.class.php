...
class Usuario extends Connect
{
  ...
  {
    $query = "INSERT INTO `usuario`(`idUser`,`Username`,`Email`,`Password`,`imagem`,`Dataregistro`,`Permissao`)VALUES (NULL, '$username', '$email', '$password', '$pt_file' , CURRENT_TIMESTAMP , '$perm' )";
  ...
  public function UpdateUser($idUser, $username, $email, $nomeimagem, $permissao = NULL)
  {
    ...
    $query = "UPDATE `usuario` SET `Username`='$username',`Email`='$email',`imagem`='$nomeimagem' $Permissao WHERE `idUser`= '$idUser'";
